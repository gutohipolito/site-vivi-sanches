        ...
        <main className="min-h-screen">
            ...
            <section className="py-24 px-10 max-w-4xl mx-auto space-y-12">
                <div className="prose prose-lg text-deep-charcoal/80 font-sans mx-auto">
                    <p>
                        Bem-vindo ao site da Clínica Sanches. Ao acessar e utilizar este site, você concorda com os seguintes termos e condições.
                    </p>

                    <h3 className="font-serif text-deep-charcoal">1. Uso do Conteúdo</h3>
                    <p>
                        Todo o conteúdo deste site (textos, imagens, logotipos) é de propriedade da Clínica Sanches e está protegido por leis de direitos autorais. O uso não autorizado é proibido.
                    </p>
                    ...
                    <p>
                        A Clínica Sanches não se responsabiliza por danos decorrentes do uso indevido das informações aqui apresentadas ou da impossibilidade de uso do site.
                    </p>
